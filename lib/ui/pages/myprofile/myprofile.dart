                      ...
                      ProfileMenu(
                        press: () async {
                          ...
                          await AuthServices.signOut().then((value) {
                            ...
                            if (value == true) {
                              ActivityServices.showToast("Logout Success", Color(0xFFf96060));
                              Navigator.pushReplacementNamed(context, Login.routeName);
                            } else {
                              ActivityServices.showToast("Log Out Failed", Color(0xFFFF7751));
                            }
                          });
                        },
                        text: "Log Out",
                ...
                onPressed: () async {
                  ...
                  if (imageFile != null) {
                    await AuthServices.changeProfilePicture(imageFile).then((value) {
                      if (value == true) {
                        ActivityServices.showToast("Profile pic updated", Color(0xFFf96060));
                      } else {
                        ActivityServices.showToast("Error update profile", Color(0xFFFF7751));
                      }
                    });
                  }
                },
